...
class _InstagramDownloaderPageState extends State<InstagramDownloaderPage> {
  ...
  final Color primaryPurple = const Color(0xFF2A2A2A);
  final Color accentPurple = const Color(0xFFFFFFFF);
  final Color lightPurple = const Color(0xFFB0B0B0);   // Light Gray highlight
  final Color primaryWhite = Colors.white;
  final Color accentGrey = const Color(0xFF8A8A8A);
  final Color cardDark = const Color(0xFF121212); // Latar kartu dengan tint abu
            ...
            children: [
              ...
              if (_errorMessage != null)
                Container(
                  padding: const EdgeInsets.all(16),
                  decoration: BoxDecoration(
                    color: Colors.purple.withOpacity(0.15), // Diubah ke ungu transparan
                    borderRadius: BorderRadius.circular(12),
