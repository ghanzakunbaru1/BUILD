...
class _NikCheckerPageState extends State<NikCheckerPage> with SingleTickerProviderStateMixin {
  ...
  final Color lightPurple = const Color(0xFFB0B0B0);
  final Color primaryWhite = Colors.white;
  final Color accentGrey = const Color(0xFF8A8A8A);
  final Color cardDark = const Color(0xFF121212); // Latar kartu dengan sedikit tint ungu
            ...
            children: [
              ...
              if (_errorMessage != null)
                Container(
                  padding: const EdgeInsets.all(16),
                  decoration: BoxDecoration(
                    color: Colors.purple.withOpacity(0.15), // Ubah ke ungu transparan
                    borderRadius: BorderRadius.circular(12),
