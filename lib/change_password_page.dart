...
class _ChangePasswordPageState extends State<ChangePasswordPage> {
  ...
  // ==================== WARNA UNGU ====================
  final Color bgDark = const Color(0xFF020103);          // Hitam pekat
  final Color bgSecondary = const Color(0xFF0B0614);     // Ungu gelap
  final Color primaryPurple = const Color(0xFFA64DFF);   // Ungu utama
  final Color accentPurple = const Color(0xFFD38BFF);    // Ungu terang/glow
  final Color primaryWhite = Colors.white;
  final Color textGrey = const Color(0xFFBFA8FF);        // Ungu muda

  final LinearGradient purpleGradient = const LinearGradient(
    colors: [Color(0xFFA64DFF), Color(0xFFD38BFF)], // Ungu gradient
