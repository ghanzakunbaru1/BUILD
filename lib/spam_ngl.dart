...
class _NglPageState extends State<NglPage> {
  ...
  final Color bgDark = const Color(0xFF000000);     // Background Utama
  final Color bgSecondary = const Color(0xFF101010); // Warna Kartu / Input
  final Color primaryPurple = const Color(0xFF202020);
  ...
  final LinearGradient purpleGradient = const LinearGradient(
    colors: [const Color(0xFFB91C1C), Color(0xFFFFFFFF)],
  ...
  Color _getStatusColor(String status) {
    ...
    if (status.contains('▶️')) return Colors.redAccent;
    if (status.contains('⏹️')) return Colors.orangeAccent;
    return primaryWhite;
  }
}