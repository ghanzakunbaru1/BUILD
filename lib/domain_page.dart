...
class _DomainOsintPageState extends State<DomainOsintPage> {
  ...
  final Color accentRed = const Color(0xFFFF0000);      // 🔴 MERAH UTAMA
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(color: accentRed), // 🔴 MERAH
        ),
      ),
    );
  }
  ...
  Widget _buildCategoryCard({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: accentRed.withOpacity(0.5), width: 1), // 🔴 MERAH
        boxShadow: [
          BoxShadow(
            color: accentRed.withOpacity(0.2), // 🔴 MERAH
            blurRadius: 10,
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                Icon(icon, color: accentRed, size: 20), // 🔴 MERAH
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          if (showCopyButton)
            IconButton(
              icon: Icon(Icons.copy, color: accentRed, size: 20), // 🔴 MERAH
  ...
  List<Widget> _buildSubdomainsList() {
    ...
    return [
      ...
      ...cleanSubdomains.map((subdomain) => Container(
        ...
        child: Row(
          children: [
            Icon(Icons.link, color: accentRed, size: 16), // 🔴 MERAH
            const SizedBox(width: 12),
            Expanded(
              child: Text(
                subdomain,
            ...
            IconButton(
              icon: Icon(Icons.copy, color: accentRed, size: 18), // 🔴 MERAH
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: cardDark,
                  borderRadius: BorderRadius.circular(16),
                  border: Border.all(color: accentRed.withOpacity(0.5)), // 🔴 MERAH
                  boxShadow: [
                    BoxShadow(
                      color: accentRed.withOpacity(0.2), // 🔴 MERAH
                      blurRadius: 8,
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        enabledBorder: OutlineInputBorder(
                          borderSide: BorderSide(color: accentRed.withOpacity(0.5)), // 🔴 MERAH
                          borderRadius: BorderRadius.circular(12),
                        ),
                        focusedBorder: OutlineInputBorder(
                          borderSide: BorderSide(color: accentRed, width: 2), // 🔴 MERAH
                          borderRadius: BorderRadius.circular(12),
                        ),
                        filled: true,
              ...
              if (_errorMessage != null)
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: cardDark,
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(color: accentRed), // 🔴 MERAH
                  ),
                  child: Row(
                    children: [
                      Icon(Icons.error_outline, color: accentRed), // 🔴 MERAH
                      const SizedBox(width: 12),
                      Expanded(
                        child: Text(
                          _errorMessage!,
