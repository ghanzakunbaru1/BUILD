...
class _ManageServerPageState extends State<ManageServerPage> {
  ...
  Future<void> _fetchVpsList() async {
    ...
    final uri = Uri.parse('http://elainakurumipanelpanel.xtxintax.my.id:2045/myServer?key=${widget.keyToken}');
    try {
  ...
  Future<void> _addVps() async {
    ...
    final uri = Uri.parse('http://elainakurumipanelpanel.xtxintax.my.id:2045/addServer');
    try {
  ...
  Future<void> _deleteVps(String host) async {
    final uri = Uri.parse('http://elainakurumipanelpanel.xtxintax.my.id:2045/delServer');
    try {
      final res = await http.post(uri, body: {
        'key': widget.keyToken,
        'host': host,
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(color: accentRed.withOpacity(0.3)), // 🔴 MERAH
        ),
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          labelText: label,
          labelStyle: TextStyle(color: accentRed), // 🔴 MERAH
          enabledBorder: OutlineInputBorder(
            borderSide: BorderSide(color: accentRed.withOpacity(0.5)), // 🔴 MERAH
            borderRadius: BorderRadius.circular(12),
          ),
          focusedBorder: OutlineInputBorder(
            borderSide: BorderSide(color: accentRed), // 🔴 MERAH
            borderRadius: BorderRadius.circular(12),
          ),
          filled: true,
                ...
                child: isLoading
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(12),
                        side: BorderSide(color: accentRed.withOpacity(0.2)), // 🔴 MERAH
                      ),
                      child: ListTile(
