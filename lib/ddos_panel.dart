...
class _AttackPanelState extends State<AttackPanel> with TickerProviderStateMixin {
  ...
  final String baseUrl = "http://elainakurumipanelpanel.xtxintax.my.id:2045";
  ...
  final Color accentPurple = const Color(0xFFFFFFFF); // Warna aksen utama (Putih)
  final Color cardDark = const Color(0xFF121212); // Warna kartu dengan tint biru-hitam
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Slider(
                      ...
                      inactiveColor: primaryWhite.withOpacity(0.15),
                      onChanged: (value) {
